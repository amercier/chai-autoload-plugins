...
Feel free to [open an issue](https://github.com/amercier/chai-autoload-plugins/issues/new),
or propose a [pull request](https://github.com/amercier/chai-autoload-plugins/pulls).
To prevent duplication, please look at [existing issues](https://github.com/amercier/chai-autoload-plugins/issues?q=is%3Aissue) before posting a new one.
...
```bash
git clone https://github.com/amercier/chai-autoload-plugins.git
```
...
```log
> chai-autoload-plugins@0.1.0-alpha.2 test /.../chai-autoload-plugins
> npm run lint && rm -rf coverage && istanbul cover _mocha -- specs --recursive --compilers js:babel-register


> chai-autoload-plugins@0.1.0-alpha.2 lint /.../chai-autoload-plugins
> eslint .
